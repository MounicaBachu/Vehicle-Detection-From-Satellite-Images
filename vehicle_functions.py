...
def vehicle_detection(uploaded_file):
    ...
    if uploaded_file is not None:
        ...
        classes = None
        with open('/mydrive/AIGuyYT/yolov4/obj.names', 'r') as f:
        ...
        net = cv2.dnn.readNet('/mydrive/AIGuyYT/yolov4/SampleDataZipped/yolov4-obj.cfg', '/mydrive/AIGuyYT/yolov4/backup/yolov4-obj_best.weights')
